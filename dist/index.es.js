...
const Mark = ({ color, className, end, start, onClick, content, tag, }) => {
    ...
    return (React.createElement("mark", { className: className, style: Object.assign({ backgroundColor: color || "#84d2ff" }, (lumin && { color: "white" })), "data-start": start, "data-end": end, onMouseUp: () => onClick({ start: start, end: end }) },
        content,
